...
import com.xushun.index.ForwardIndexService;
import com.xushun.index.InvertedIndexService;
...
public class QueryTest {
	...
	public static void query() {
		...
		String str = "教育部重点实验室评估组";
		QueryService service = new QueryService(str);
	...
	public static void query2() {
		...
		HashSet<String> stopWordSet = WordUtil.getStopWordSet();
		HashSet<String> wordSet = WordUtil.getWordSet();
		
		ForwardIndexService.createForwardIndex(1,longText1);
		ForwardIndexService.createForwardIndex(2,longText2);
		ForwardIndexService.createForwardIndex(3,longText3);
		
		Map<Integer, ArrayList<String> > forwordIndex = ForwardIndexService.globalForwordIndex;
...
//		}
		...
		InvertedIndexService.createInvertedIndex(forwordIndex);
		Map<String, ArrayList<Integer>> globalInvertedIndex = InvertedIndexService.globalInvertedIndex;
//		for(Map.Entry<String, ArrayList<Integer>> entry: InvertedIndexService.globalInvertedIndex.entrySet()) {
//			System.out.println(entry);
//		}
